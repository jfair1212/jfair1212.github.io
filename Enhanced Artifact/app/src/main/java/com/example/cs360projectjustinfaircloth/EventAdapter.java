    ...
    public void onBindViewHolder(@NonNull EventAdapter.EventViewHolder holder, int position) {
        ...
        holder.deleteEventButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String docId = event.getFireStoreId();

                events.remove(adapterPosition);
                notifyItemRemoved(adapterPosition);
                notifyItemRangeChanged(adapterPosition, events.size());

                Toast.makeText(v.getContext(), "Event deleted.", Toast.LENGTH_SHORT).show();

                new EventDatabaseFirebase().deleteEvent(docId, null, null);
            }
        });
        ...
        holder.editEventButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(context, editEventScreen.class);


                intent.putExtra("event_id", event.getFireStoreId());
